...
export const locationCities: Record<string, Omit<LocationData, "slug" | "type">> = {
  ...
  rishikesh: {
    ...
    marketInsight: "As our manufacturing home base, Dehradun studios, wellness centers, and hospitality partners receive direct installation support and custom configurations for intensive training programs.",
    industryFocus: "Studio integrations, wellness education spaces, and factory-direct local installations.",
    localHubs: ["Indira Nagar Colony", "Rajpur Road", "Jakhan", "Race Course"],
  },
  gurgaon: {
    name: "Gurgaon",
    region: "north",
...
export const locationStates: Record<string, Omit<LocationData, "slug" | "type">> = {
  ...
  uttarakhand: {
    ...
    region: "north",
    deliveryDays: "1-2 days",
    marketInsight: "As the birthplace of our brand, Uttarakhand's wellness retreats in Dehradun, Haridwar, and Mussoorie enjoy fast delivery and direct installation support for yoga and Pilates hybrid spaces.",
    industryFocus: "Wellness training rooms, luxury spa resorts, and local boutique teacher training centers.",
    localHubs: ["Dehradun", "Haridwar", "Mussoorie", "Nainital"],
  },
  "west-bengal": {
    name: "West Bengal",
    region: "east",
